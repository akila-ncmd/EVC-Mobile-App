...
void main() {
  ...
  /// Renders the app through its real router, so shell chrome — the bottom
  /// bar, the mini player — is part of the golden.
  ...
  testWidgets(
    'onboarding',
    (t) => shoot(t, '02_onboarding', const OnboardingScreen()),
  );
  ...
  testWidgets(
    'interests',
    (t) => shoot(t, '06_interests', const InterestsScreen()),
  );
  testWidgets('home shell', (t) => shootRoute(t, '07_home_shell', '/home'));
  testWidgets(
    'component gallery',
    (t) => shoot(t, '08_gallery', const GalleryScreen()),
  );

  // Sprint 3 — consumer core
  testWidgets(
    'home',
    (t) => shoot(t, '09_home', const Scaffold(body: HomeScreen())),
  );
  testWidgets(
    'discovery',
    (t) => shoot(t, '10_discovery', const Scaffold(body: DiscoveryScreen())),
  );
  testWidgets(
    'about',
    (t) => shoot(t, '11_about', const AboutScreen(id: 'v1')),
  );
  testWidgets(
    'player',
    (t) => shoot(t, '12_player', const PlayerScreen(id: 'v1')),
  );
  testWidgets(
    'library',
    (t) => shoot(t, '13_library', const Scaffold(body: LibraryScreen())),
  );
  testWidgets(
    'owned list',
    (t) => shoot(
  ...
  testWidgets(
    'music',
    (t) => shoot(t, '15_music', const Scaffold(body: MusicScreen())),
  );
  testWidgets(
    'now playing',
    (t) => shoot(t, '16_now_playing', const NowPlayingScreen()),
  );
  testWidgets(
    'settings',
    (t) => shoot(t, '17_settings', const Scaffold(body: SettingsScreen())),
  );

  // Sprint 5 — creator side
  testWidgets(
    'creator hub',
    (t) => shoot(t, '18_creator_hub', const CreatorHubScreen()),
  );
  testWidgets(
    'studio publish',
    (t) => shoot(t, '19_studio_publish', const CreatorStudioScreen()),
  );
  testWidgets(
    'studio unpublish',
    (t) => shoot(
      t,
      '20_studio_unpublish',
      const CreatorStudioScreen(initialTab: 1),
    ),
  );
  testWidgets(
    'studio monitor',
    (t) =>
        shoot(t, '21_studio_monitor', const CreatorStudioScreen(initialTab: 2)),
  );
  testWidgets(
    'publish video',
    (t) => shoot(t, '22_publish_video', const PublishVideoScreen()),
  );
  testWidgets(
    'analytics',
    (t) => shoot(t, '23_analytics', const AnalyticsScreen()),
  );
  testWidgets(
    'my videos',
    (t) => shoot(t, '24_my_videos', const MyVideosScreen()),
  );
  testWidgets(
    'balance',
    (t) => shoot(t, '25_balance', const AccountBalanceScreen()),
  );

  // Sprint 6 — people
  testWidgets(
    'people',
    (t) => shoot(t, '26_people', const PeopleScreen(initialTab: 1)),
  );
}
